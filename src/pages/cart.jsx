...
export function Cart() {
    ...
    const addedGoodsInCart = Object.keys(items).map((key) => {
                    ...
                    <div className="cart">
                        ...
                        <div className="content__items">
                            { addedGoodsInCart.map((obj) => (
                                <CartItem
                                    ...
                                    type={obj.type}
                                    size={obj.size} 
                                    totalPriceInItem={items[obj.id].totalPriceInItem}
                                    itemCountInPosition={items[obj.id].items.length}
                                    onRemove={handleRemoveCartItem}
                                    onPlus={handleItemPlus}
                                    onMinus={handleItemMinus}
                                    /> 
                            ))}
                        </div>
                        <div className="cart__bottom">
                            <div className="cart__bottom-details">
                                ...
                                <span> Сумма заказа: <b>{totalPrice} &euro;</b> </span>
                            </div>
